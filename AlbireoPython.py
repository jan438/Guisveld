...
def albireo(c, x, y):
    ...
    c.radialGradient(middle_x, speaker_y, speaker_r + 25, ("#EEEFEA", "#EEEFEA"), extend=False)
    ...
    c.radialGradient(middle_x, alarmbutton_y, alarmbutton_r + 15, ("#EEEFEA", "#EEEFEA"), extend=False)
