...
def albireo(c, x, y):
    ...
    renderPDF.draw(scaleSVG("SVG/arc_60_120degouter.svg", 0.5), c, x + 20, y + 20)
    renderPDF.draw(scaleSVG("SVG/arc_60_120deg.svg", 0.5), c, x + 20, y + 20)
    renderPDF.draw(scaleSVG("SVG/arc_150_210degouter.svg", 0.5), c, x + 20, y + 20)
    renderPDF.draw(scaleSVG("SVG/arc_150_210deg.svg", 0.5), c, x + 20, y + 20)
    renderPDF.draw(scaleSVG("SVG/arc_240_300degouter.svg", 0.5), c, x + 20, y + 20)
