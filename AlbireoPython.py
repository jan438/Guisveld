...
def albireo(c, x, y):
    ...
    strwidth = pdfmetrics.stringWidth("Alβireo", cheatsheetfont, 12)
    c.drawString(middle_x - 0.55 * strwidth, speaker_y+10, "Alβireo")
    ...
    c.drawString(middle_x, alarmbutton_y-10, "ALARM")
    c.setFillColor(HexColor('#ffffff'))
